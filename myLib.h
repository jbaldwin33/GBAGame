...
typedef struct {	//Struct for sprites
    int row;
    int col;
    int start;
    int shape;
    ...
    //int type; //0 = character, 1 = object, 2 = enemy
} Sprite;
...
int collisionLeft(int i, Sprite *s, int* health);
int collisionRight(int i, Sprite *s, int* health);
int collisionUp(int i, Sprite *s, int* health);
int collisionDown(int i, Sprite *s, int* health);
