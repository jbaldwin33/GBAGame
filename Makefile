...
OFILES = myGame.o myLib.o titleScreen.o screen1.o text.o font.o boulder.o sAndB.o level.o wasteland.o gameover.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h titleScreen.h screen1.h text.h font.h boulder.h sAndB.h level.h wasteland.h gameover.h
